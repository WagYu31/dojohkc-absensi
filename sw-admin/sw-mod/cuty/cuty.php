    ...
    <tr>
      ...
      <td class="text-center">
        ...
        if($level_user==1){
          echo'
          <div class="btn-group">
            <button type="button" class="btn btn-warning btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Proses
              <span class="caret"></span>
              <span class="sr-only">Toggle Dropdown</span>
            </button>
            <ul class="dropdown-menu" role="menu">
            <li><a href="javascript:void(0);" data-id="'.$row['cuty_id'].'" data-status="1" class="btn-setujui">Setujui</a></li>

              <li><a href="javascript:void(0);" data-id="'.$row['cuty_id'].'" data-status="2" class="update-status">Tidak disetujui</a></li>
            </ul>
          </div>
          
          <a href="'.$mod.'/print?action=print&id='.epm_encode($row['cuty_id']).'" target="_blank"  class="btn btn-sm btn-danger delete" title="Print"><i class="fa fa-print" aria-hidden="true"></i> Print</a>';}
        else{
        echo'
          ...
          <buton type="button" class="btn btn-sm btn-danger access-failed" title="Hapus"><i class="fa fa-trash-o"></i> Hapus</button>';
        }
        echo'
        </div>
