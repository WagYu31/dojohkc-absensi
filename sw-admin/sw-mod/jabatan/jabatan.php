...
<section class="content-header">
  <h1>Tingkatan<small> Sabuk</small></h1>
    <ol class="breadcrumb">
      <li><a href="./"><i class="fa fa-dashboard"></i> Beranda</a></li>
      <li class="active">Tingkatan Sabuk</li>
    </ol>
</section>';
echo'
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Tingkatan Sabuk</b></h3>
           ...
           while ($row= $result->fetch_assoc()) {
              ...
              <tr>
                ...
                <td class="text-center">
                  ...
                  if($level_user==1){
                    echo'
                    <a href="#modalEdit" class="btn btn-warning btn-sm enable-tooltip" title="Edit" data-toggle="modal"';?> onclick="getElementById('txtid').value='<?PHP echo $row['position_id'];?>';getElementById('txtnama').value='<?PHP echo $row['position_name'];?>';"><i class="fa fa-pencil-square-o"></i></a>
                <?php echo'
                <buton data-id="'.epm_encode($row['position_id']).'" class="btn btn-sm btn-danger delete" title="Hapus"><i class="fa fa-trash-o"></i></button>';}
                else {
                  echo'
