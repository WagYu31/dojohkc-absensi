...
echo'
  <footer class="main-footer">
    <div class="pull-right hidden-xs">Theme LTE / 
     ...
     &copy; 2022 - '.DATE('Y').' '.$site_name.' | Design With <i class="fa fa-heart"></i> From <span id="credits"><a class="credits" href="https://s-widodo.com" target="_blank" id="credits">'.$site_name.'</a> - All Rights Reserved</span>
  </footer>
</div>
<!-- wrapper -->
...
<script src="./sw-assets/plugins/tinymce/tinymce.min.js"></script>';
