  ...
  echo'<!-- App Capsule -->
    ...
    <div class="card-body">
        ...
        <div class="col-sm-4 col-md-4 justify-content-between">
           <button type="button" class="btn btn-danger mt-1 mr-1 btn-sortir-cuty"><ion-icon name="checkmark-outline"></ion-icon>Tampil</button>
           <button type="button" class="btn btn-success mt-1 mr-1 btn-clear-cuty"><ion-icon name="repeat-outline"></ion-icon> Clear</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form-add-cuty" autocomplete="off">
                            ...
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    <label class="label">Tanggal Masuk Latihan</label>
                                        <div class="input-group">
                            ...
                            <div class="form-group basic">
                                <button type="submit" class="btn btn-danger btn-block mt-2">Simpan</button>
                            </div>
                        </form>
