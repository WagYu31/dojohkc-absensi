...
$(document).on('click', '.btn-modal-shift', function(){
    ...
    $('.modal-title').html('Pilih Jam Latihan');
});
...
$('.jam-kerja').on('change', function () {
    var jam_kerja = $(this).val(); 
    window.location = './absent&shift='+jam_kerja+'';
    return false;
});
...
$(document).on('click', '.btn-bayar', function(){
    ...
    $('.modal-title').html('Pembayaran SPP');
});

$(document).on('click', '.btn-submit-spp', function(){
    var nominal = $('.nominal').val();
    var tahun = $('.tahun-pelajaran').val();
    if(nominal=='' || tahun ==''){

    }else{
        window.location.href = './pembayaran-spp&jum='+nominal+'&tahun_ajaran='+tahun+'';
    }
});
...
function loadDataSpp() {
    var tahun = $('.tahun-pelajaran').val();
    $.ajax({
        url: './sw-proses?action=histori-spp',
        type: 'POST',
        data: {tahun: tahun},
        success: function(data) {
            $('.loaddataSpp').html(data);
        }
    });
}
...
$('.tahun-pelajaran').on('change', function() {
    var tahun = $('.tahun-pelajaran').val();
    $(window).attr('location','spp&tahun_ajaran='+tahun+'');
});